...
echo "╚════════════════════════════════════════╝"
echo ""
print_success "Frontend: https://kn-tech.click"
print_success "Backend API: https://api.kn-tech.click"
echo ""
print_info "API Endpoints:"
echo "  - https://api.kn-tech.click/api/v1/health"
echo "  - https://api.kn-tech.click/api/v1/users"
echo ""
